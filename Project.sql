...
-- WITH forest_1990 AS (
-- 	SELECT
-- 		ROUND(SUM(forest_area_sqkm) :: numeric, 2) AS forest_area_1990
-- 	FROM
-- 		forestation
-- 	WHERE
-- 		year = 1990
...
-- forest_2016 AS (
-- 	SELECT
-- 		ROUND(SUM(forest_area_sqkm) :: numeric, 2) AS forest_area_2016
-- 	FROM
-- 		forestation
-- 	WHERE
-- 		year = 2016
...
-- 		forest_area_1990,
-- 		forest_area_2016,
-- 		forest_area_1990 - forest_area_2016 AS diffrence
-- 	FROM
-- 		forest_1990,
-- 		forest_2016
-- ),
...
-- )
-- SELECT
-- 	distinct round(total_area_sqkm :: numeric, 2) AS area_same,
-- 	country_name
-- FROM
-- 	diff,
-- 	total_area
-- WHERE
-- 	diffrence >= total_area_sqkm
-- ORDER BY
-- 	1 DESC
-- LIMIT
-- 	5;
...
-- Que.2What was the percent forest of the entire world in 1990? Which region had the HIGHEST percent forest in 1990, and which had the LOWEST, to 2 decimal places?
-- SELECT region, ROUND ((SUM(forest_area_sqkm) * 100/ SUM(total_area_sq_mi * 2.59))::numeric, 2) AS percentag
-- FROM forestation
-- WHERE year = 1990
-- GROUP BY region
...
-- WITH fa1990 AS (
-- 	SELECT
-- 		SUM(forest_area_sqkm) AS sum_1990,
-- 		country_name,
-- 		region
-- 	FROM
-- 		forestation
...
-- fa2016 AS (
-- 	SELECT
-- 		SUM(forest_area_sqkm) AS sum_2016,
-- 		country_name,
-- 		region
-- 	FROM
-- 		forestation
...
-- )
-- SELECT
-- 	ROUND((sum_1990 - sum_2016) :: numeric, 2) AS di,
-- 	a.country_name,
-- 	a.region
-- FROM
-- 	fa2016 a
-- 	JOIN fa1990 b ON a.country_name = b.country_name
-- ORDER BY
-- 	di DESC;

-- que 3If countries were grouped by percent forestation in quartiles, which group had the most countries in it in 2016?
-- WITH
-- fa2016 AS (
